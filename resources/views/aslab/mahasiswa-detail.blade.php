...
@section('content')
    <section class="section">
        <div class="section-header">
            ...
            @else
                <button class="btn btn-info" onclick="document.location.href = '{{ route('asisten.mahasiswa-edit', $mahasiswa->id) }}'">
    ...
    <form action="{{ route('asisten.mahasiswa-action', 'verifikasi') }}" method="POST" id="formVerifikasi">
        @csrf
        <input type="hidden" name="id" value="{{ $mahasiswa->id }}">
    </form>
    <form action="{{ route('asisten.mahasiswa-action', 'tolak') }}" method="POST" id="formTolak">
        @csrf
        <input type="hidden" name="id" value="{{ $mahasiswa->id }}">
    </form>
@endsection
