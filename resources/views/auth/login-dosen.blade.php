        ...
        <div class="card-body px-5 py-4">
            <div class="row">
                <div class="col-lg-8 d-none d-lg-flex justify-content-center">
                    <img src="{{ asset('assets/img/dosen.svg') }}" alt="img" class="w-65">
                </div>
                <div class="col-lg-4">
                    ...
                    <form method="POST">
                        ...
                        <button type="button" class="btn btn-info btn-block" onclick="document.location.href = '{{ route('login') }}'">Login Mahasiswa</button>
                    </form>
                </div>
            </div>
